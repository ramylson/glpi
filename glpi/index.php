...
if (!file_exists(GLPI_CONFIG_DIR . "/config_db.php")) {
   ...
   echo "<div id='menuinterno'><a href='http://www.perimpecas.com.br'target='_blank'>Home</a>
        <span class='divisor-menu'></span>
        <a href='http://webmail.perimpecas.com.br/' target='_blank'>Webmail</a>
        <span class='divisor-menu'></span>
        <a href='http://www.perimpecas.com.br/s' target='_blank'>SRA</a>
        <span class='divisor-menu'></span>
        <a href='#' target='_blank'>Manual</a>
        </div>";
        
   echo "<div id='text-login'>
            <div id='text-login-box'>Utilize os dados do seu e-mail institucional para acessar:<br />
            Usuário: usuario <span style='color: #fec95c;'><b>usuario@perimpecas.com.br</b></span><br />
            Senha: senha do e-mail</div>
        </div>";
   /*echo "<div id='text-login'>";
